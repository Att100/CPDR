config = {
    'name': "unet_cpdr_a_efficientnetb0_dice_iou",
    'structure': {
        'select': 'fpn_with_neck',
        'backbone': {
            'select': "efficientnet_b0"
        },
        'mappers': {
            'block_cfgs': [
                ['mapr1', 'conv2d_bn_relu', [1280, 128, 1]],
                ['mapr2', 'conv2d_bn_relu', [112, 128, 1]],
                ['mapr3', 'conv2d_bn_relu', [40, 64, 1]],
    ...
    'training': {
        'pretrained': True,
        'backbone_pretrained_path': "./ckpts/pretrained/efficientnet-b0-355c32eb.pdparams",
